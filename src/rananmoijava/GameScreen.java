...
public class GameScreen extends JPanel implements Runnable{
    ...
    public void painBG(Graphics  g){
        ...
        g.fillRect(0, 0, WIDTH+padding*2 + 200, HEIGH+padding*2);
        for(int i=0 ; i<20 ; i++){
            for(int j=0 ; j<20; j++){
//                g.fillRect(i*20+1, j*20+1,18, 18); //vẽ lưới
	...
	g.drawRect(0, 0, WIDTH+padding*2 +200, HEIGH+padding*2);
	g.drawRect(1, 1, WIDTH+padding*2-2 +200, HEIGH+padding*2-2);
	g.drawRect(2, 2, WIDTH+padding*2-4+200, HEIGH+padding*2-4);
    }

...
//            if(y[0] > 19) y[0] = 0;
    ...
    public void VeRan(Graphics g){
        ...
        if(vector == ConRan.GO_UP)g.drawImage(data.HeadGoUp.getCurrentImage(), x[0]*20-7+GameScreen.padding, y[0]*20-7+GameScreen.padding, 30,30, null);
        else if(vector == ConRan.GO_DOWN) g.drawImage(data.HeadGoDown.getCurrentImage(), x[0]*20-7+GameScreen.padding, y[0]*20-7+GameScreen.padding, 30,30, null);
        else if(vector == ConRan.GO_LEFT) g.drawImage(data.HeadGoLeft.getCurrentImage(), x[0]*20-7+GameScreen.padding, y[0]*20-7+GameScreen.padding, 30,30, null);
        else if(vector == ConRan.GO_RIGHT) g.drawImage(data.HeadGoRight.getCurrentImage(), x[0]*20-7+GameScreen.padding, y[0]*20-7+GameScreen.padding, 30,30, null);
    }
}
